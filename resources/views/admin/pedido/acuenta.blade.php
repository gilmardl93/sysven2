...
@section('title') PEDIDOS A CUENTA
@stop

@section('titulo') PEDIDOS A CUENTA
@stop
...
@section('content')
    ...
    @if (session('final'))
        <div class="alert alert-success">
            {{ session('final') }} <a href="{!! url('reporte-factura') !!}" target="_lblank" class="btn default green-stripe">VER PEDIDO</a>
        </div>
    @endif
        ...
        <div class="col-md-8"> 
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    {!! Form::open(['method' => 'POST', 'url' => 'agregar-producto-pedido']) !!}
                    <div class="row">
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-8">
                ...
                <table class="table table-bordered table-hover Productos-agregados" >
                    <thead>
                        ...
                        <tr>
                            ...
                            <td> <a href="eliminar-producto-pedido/{!! $row->id !!} " title="Eliminar" class="btn btn-icon-only red" ><i class="fa fa-trash"></i></a> </td>
                        </tr>
                        @endforeach
                    <tbody>
                    </tbody>
        ...
        <div class="col-md-4">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <label>DEJA A CUENTA</label>
                            {!! Form::text('acuenta', 0, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <br>
                    <div class="row">
